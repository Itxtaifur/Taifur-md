...
yt.getInfo = async (r, u = {}) => {
  try {
    ...
    console.log("./lib/Taifur/yt.getInfo()\n", E.message);
    return {
      status: false
    };
  }
...
yt.download = async (r, u = {
  ...
  try {
    ...
    console.log("./lib/Taifur/yt.dowanload()\n", Q.message);
    return false;
  }
};
async function sendAnimeReaction(r, u = "punch", H = "", o = "") {
  try {
    ...
    await r.error(K);
    return console.log("./lib/Taifur.js/sendAnimeReaction()\n", K);
  }
}
async function sendGImages(r, u, H = Config.caption, o = "") {
  try {
    ...
    await r.error(E);
    return console.log("./lib/Taifur.js/sendGImages()\n", E);
  }
}
...
async function randomeFunfacts(r) {
  try {
    ...
    await msg.error(h);
    return console.log("./lib/Taifur.js/randomeFunfacts()\n", h);
  }
}
async function audioEditor(r, u = "bass", H = "") {
  ...
  try {
    ...
    await r.error(f + "\n\ncmdName : " + u + "\n");
    return console.log("./lib/Taifur.js/audioEditor()\n", f);
  }
}
async function send(r, u, H = {
  ...
  try {
    ...
    return console.log("./lib/Taifur.js/send()\n", f);
  }
}
async function react(r, u, H = "") {
  try {
    ...
    return console.log("./lib/Taifur.js/react()\n", z);
  }
}
let note = {
