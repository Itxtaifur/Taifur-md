...
smd(
  ...
  async (_0x42b3b8, _0x3f3887) => {
    try {
      ...
      if (!_0x1b0897) {
        return _0x42b3b8.reply("Provide me a query ex Who is Taifur");
      }
...
smd(
  ...
  async (_0x45da98) => {
    try {
      ...
      let _0x1c73f9 = (
        "\nTaifur Md A simple Mutil Device WhatsApp Bot Created and Managed by *" +
        Config.ownername +
        "*. 👑\n\n  *❲❒❳ Stars:* " +
        ...
        "\n  *❲❒❳ Repo:* https://github.com/Itxtaifur/TAIFUR-X-LUCIFER\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
  ...
  async (_0x2acf30) => {
    try {
      if (
        ...
        if (
          _0x2acf30.reply_text.includes("taifur-ᴍᴅ • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
          _0x2dfb59[0].includes("taifur-ᴍᴅ • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
          ...
          try {
            if (_0x2ecd2a) {
              ...
              if (_0x13a11c.toLowerCase().startsWith("reply")) {
                ...
                let _0x3f6b59 =
                  "*taifur-ᴍᴅ • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
