...
smd({
  ...
  try {
    ...
    if (!_0x1c586e) {
      return await _0x1ae8f8.reply("*Provide Repo Url, _.gitclone https://github.com/Itxtaifur/TAIFUR-X-LUCIFER*");
    }
...
smd({
  ...
  category: "downloader",
  filename: __filename,
  use: "<Hii,this is LUCIFER>"
}, async (_0x55aba2, _0x56da6b) => {
  try {
    let _0x204f81 = _0x55aba2.reply_text ? _0x55aba2.reply_text : _0x56da6b;
    if (!_0x204f81) {
      return _0x55aba2.reply("*_Example : .tts Hi,I am Taifur-Md whatsapp bot._*");
    }
    try {
...
smd({
  ...
  try {
    ...
    try {
      ...
      let _0x3448d2 = _0x4e4465.title || _0x3e3caf || _0x421809[1] || "Taifur MD -- YT Video";
      if (_0x3e3caf) {
...
smd({
  ...
  try {
    ...
    let _0x4737bb = {
      audio: _0x2ba501,
      fileName: "Taifurl-Md tiktok Sound" + _0x19c223 + ".m4a",
      mimetype: "audio/mpeg",
      ptt: true,
...
cmd({
  ...
  if (_0xb75e78.quoted && _0xb75e78.text) {
    ...
    if (_0x5b8ee5[0].includes("Taifur-ᴍᴅ • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
    ...
    } else if (_0x5b8ee5[0].includes("TAIFUR-ᴍᴅ • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
